...
train_loader, test_loaders, data_processor = load_darcy_flow(
    ...
    train_data_setting={'tau': tau, 'alpha': alpha, 'boundary': 'ARD2'},
    test_data_settings=[{'tau': tau, 'alpha': alpha, 'boundary': 'ARD2'}],
...
wandb.init(
    ...
    name=f'UNO_alph_2_tau_10_ARD2_1024'
)
...
model_path = os.path.join(save_dir, f"cno_model_{batch}.pth")
