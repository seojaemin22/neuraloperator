...
train_loader, test_loaders, data_processor = load_darcy_flow(
    ...
    train_data_setting={'tau': tau, 'alpha': alpha, 'boundary': 'ZD', 'coeff_type': 'hard4'},
    test_data_settings=[{'tau': tau, 'alpha': alpha, 'boundary': 'ZD', 'coeff_type': 'hard4'}],
)
...
wandb.init(
    ...
    name= f'FNO_alph_2_tau_5_ARD1_{resolution}_hard4'
)
